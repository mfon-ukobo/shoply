                            ...
                            <div class="dropdown-menu-list-submenu">
                               <div>
                                  <ul class="list-unstyled">
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Fresh Vegetables</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Herbs &amp; Seasonings</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Fresh Fruits</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Organic Fruits &amp; Vegetables</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Cuts &amp; Sprouts</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Exotic Fruits &amp; Veggies</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Flower Bouquets, Bunches</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Specialty</a>
                                     </li>
                                  </ul>
                               </div>
                               ...
                               <div>
                                  <ul class="list-unstyled">
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Banana &amp; Papaya</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Kiwi, Citrus Fruit</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Apples &amp; Pomegranate</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Seasonal Fruits</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Mangoes</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Fruit Baskets</a>
                                     </li>
                                  </ul>
                               </div>
                            </div>
                         ...
                         <li class="dropdown-menu-list">
                            <a href="javascript:void(0)" class="dropdown-item d-flex justify-content-between mb-1 py-1">
                               <div>
                                  ...
                                  <span class="ms-1">Snack &amp; Munchies</span>
                               </div>
                               <div>
                                  <i class="feather-icon icon-chevron-right"></i>
                               </div>
                            ...
                            <div class="dropdown-menu-list-submenu">
                               <div>
                                  <ul class="list-unstyled">
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Chips &amp; Crisps</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Nachos</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Popcorn</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Bhujia &amp; Mixtures</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Namkeen Snacks</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Healthy Snacks</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Cakes &amp; Rolls</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Energy Bars</a>
                                     </li>
                                  </ul>
                               </div>
                               ...
                               <div>
                                  <ul class="list-unstyled">
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Papad &amp; Fryums</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Glucose &amp; Milk Biscuits</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Glucose &amp; Milk Biscuits</a>
                                     </li>
                         ...
                         <li class="dropdown-menu-list">
                            <a href="javascript:void(0)" class="dropdown-item d-flex justify-content-between mb-1 py-1">
                               <div>
                                  ...
                                  <span class="ms-1">Bakery &amp; Biscuits</span>
                               </div>
                               <div>
                                  <i class="feather-icon icon-chevron-right"></i>
                               </div>
                            ...
                            <div class="dropdown-menu-list-submenu">
                               <div>
                                  <ul class="list-unstyled">
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Cookies</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Glucose &amp; Marie</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Sweet &amp; Salty</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Healthy &amp; Digestive</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Cream Biscuits</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Rusks &amp; Wafers</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Cakes &amp; Rolls</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Buns &amp; Bakery</a>
                                     </li>
                                  </ul>
                               </div>
                         ...
                         <li class="dropdown-menu-list">
                            <a href="javascript:void(0)" class="dropdown-item d-flex justify-content-between mb-1 py-1">
                               <div>
                                  ...
                                  <span class="ms-1">Cold Drinks &amp; Juices</span>
                               </div>
                               <div>
                                  <i class="feather-icon icon-chevron-right"></i>
                               </div>
                            ...
                            <div class="dropdown-menu-list-submenu">
                               <div>
                                  <ul class="list-unstyled">
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Soft Drinks</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Fruit Juices</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Coldpress</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Energy Drinks</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Water &amp; Ice Cubes</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Soda &amp; Mixers</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Concentrates &amp; Syrups</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Detox &amp; Energy Drinks</a>
                                     </li>
                                  </ul>
                               </div>
                               ...
                               <div>
                                  <ul class="list-unstyled">
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Juice Collection</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Concentrates &amp; Syrups</a>
                                     </li>
                         ...
                         <li class="dropdown-menu-list">
                            <a href="javascript:void(0)" class="dropdown-item d-flex justify-content-between mb-1 py-1">
                               <div>
                                  ...
                                  <span class="ms-1">Dairy, Bread &amp; Eggs</span>
                               </div>
                               <div>
                                  <i class="feather-icon icon-chevron-right"></i>
                               </div>
                            ...
                            <div class="dropdown-menu-list-submenu">
                               <div>
                                  <ul class="list-unstyled">
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Milk</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Milk Drinks</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Curd &amp; Yogurt</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Eggs</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Bread</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Buns &amp; Bakery</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Butter &amp; More</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Cheese</a>
                                     </li>
                                  </ul>
                               </div>
                               ...
                               <div>
                                  <ul class="list-unstyled">
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Paneer &amp; Tofu</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Cream &amp; Whitener</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Condensed Milk</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Vegan Drinks</a>
                                     </li>
                                  </ul>
                               </div>
                            </div>
                         ...
                         <li class="dropdown-menu-list">
                            <a href="javascript:void(0)" class="dropdown-item d-flex justify-content-between mb-1 py-1">
                               <div>
                                  ...
                                  <span class="ms-1">Chicken, Meat &amp; Fish</span>
                               </div>
                               <div>
                                  <i class="feather-icon icon-chevron-right"></i>
                               </div>
                            ...
                            <div class="dropdown-menu-list-submenu">
                               <div>
                                  <ul class="list-unstyled">
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Chicken</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Sausage, Salami &amp; Ham</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Exotic Meat</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Eggs</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Frozen Non-Veg Snacks</a>
                                     </li>
                                  </ul>
                               </div>
                            </div>
                         ...
                         <li class="dropdown-menu-list">
                            <a href="javascript:void(0)" class="dropdown-item d-flex justify-content-between mb-1 py-1">
                               <div>
                                  ...
                                  <span class="ms-1">Baby Care</span>
                               </div>
                               <div>
                                  <i class="feather-icon icon-chevron-right"></i>
                               </div>
                            ...
                            <div class="dropdown-menu-list-submenu">
                               <div>
                                  <ul class="list-unstyled">
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Diapers, Wipes &amp; More</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Baby Food</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Bath &amp; Hair Care</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Oral &amp; Nasal Care</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Baby Skin Care Online</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Cleaning Needs Online</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Feeding Accessories Online</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Baby Pharma</a>
                                     </li>
                                  </ul>
                               </div>
                               ...
                               <div>
                                  <ul class="list-unstyled">
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Mother Care</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Baby Gift Set</a>
                                     </li>
                                     <li>
                                        <a href="javascript:void(0)" class="dropdown-item">Kids Toys &amp; More</a>
                                     </li>
                                  </ul>
                               </div>
                            </div>
