...
<section class="mt-8">
    <div class="container">
       <div class="hero-slider">
          <div style="background: url(../assets/images/slider/hero-img-slider-1.jpg) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
          ...
          <div style="background: url(../assets/images/slider/hero-img-slider-3.jpg) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
             <div class="ps-lg-12 py-lg-16 col-xxl-5 col-lg-7 col-md-8 py-14 px-8 text-xs-center">
                ...
                <div class="product-slider-four-column">
                   ...
                   <div class="item">
                      ...
                      <div class="card card-product mb-4">
                         <div class="card-body text-center py-8">
                            <!-- img -->
                            <a href="#"><img src="../assets/images/category/category-snack-munchies.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                            <!-- text -->
                         </div>
                      </div>
                      <div>
                   ...
                   <div class="item">
                      ...
                      <div class="card card-product mb-4">
                         <div class="card-body text-center py-8">
                            <!-- img -->
                            <a href="#"><img src="../assets/images/category/category-dairy-bread-eggs.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                            <!-- text -->
                         </div>
                      </div>
                      <div>
                         <span class="badge bg-danger rounded-pill">-12%</span>
                         <h2 class="mt-3 fs-6"><a href="#" class="text-inherit">Blueberry Greek Yogurt</a></h2>
                         <div>
                   ...
                   <div class="item">
                      ...
                      <div>
                         ...
                         <h2 class="mt-3 fs-6"><a href="#" class="text-inherit">Kellogg s Original Cereals</a></h2>
                         <div>
                            <span class="text-dark fs-5 fw-bold">$18</span>
                            <span class="text-decoration-line-through text-muted">$24</span>
                         </div>
                   ...
                   <div class="item">
                      ...
                      <div class="card card-product mb-4">
                         <div class="card-body text-center py-8">
                            <!-- img -->
                            <a href="#"><img src="../assets/images/category/category-tea-coffee-drinks.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                            <!-- text -->
                         </div>
                      </div>
                      <div>
                         <span class="badge bg-danger rounded-pill">-45%</span>
                         <h2 class="mt-3 fs-6"><a href="#" class="text-inherit">Tea Coffee & Drinks</a></h2>
                         <div>
                            <span class="text-dark fs-5 fw-bold">$18</span>
                            <span class="text-decoration-line-through text-muted">$24</span>
                         </div>
                   ...
                   <div class="item">
                      ...
                      <div class="card card-product mb-4">
                         <div class="card-body text-center py-8">
                            <!-- img -->
                            <a href="#"><img src="../assets/images/category/category-bakery-biscuits.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                            <!-- text -->
                         </div>
                      </div>
                      <div>
                         <span class="badge bg-danger rounded-pill">-25%</span>
                         <h2 class="mt-3 fs-6"><a href="#" class="text-inherit">Slurrp Millet Chocolate</a></h2>
                         <div>
                   ...
                   <div class="item">
                      ...
                      <div class="card card-product mb-4">
                         <div class="card-body text-center py-8">
                            <!-- img -->
                            <a href="#"><img src="../assets/images/category/category-atta-rice-dal.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                            <!-- text -->
                         </div>
                      </div>
                      <div>
                         <span class="badge bg-danger rounded-pill">-55%</span>
                         <h2 class="mt-3 fs-6"><a href="#" class="text-inherit">Atta, Rice & Dal</a></h2>
                         <div>
                            <span class="text-dark fs-5 fw-bold">$18</span>
                            <span class="text-decoration-line-through text-muted">$24</span>
                         </div>
                   ...
                   <div class="item">
                      ...
                      <div class="card card-product mb-4">
                         <div class="card-body text-center py-8">
                            <!-- img -->
                            <a href="#"><img src="../assets/images/category/category-chicken-meat-fish.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                            <!-- text -->
                         </div>
                      </div>
                      <div>
                         <span class="badge bg-danger rounded-pill">-45%</span>
                         <h2 class="mt-3 fs-6"><a href="#" class="text-inherit">Chicken, Meat & Fish</a></h2>
                         <div>
                            <span class="text-dark fs-5 fw-bold">$18</span>
                            <span class="text-decoration-line-through text-muted">$24</span>
                         </div>
                   ...
                   <div class="item">
                      ...
                      <div class="card card-product mb-4">
                         <div class="card-body text-center py-8">
                            <!-- img -->
                            <a href="#"><img src="../assets/images/category/category-cleaning-essentials.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                            <!-- text -->
                         </div>
                      </div>
                      <div>
                         <span class="badge bg-danger rounded-pill">-25%</span>
                         <h2 class="mt-3 fs-6"><a href="#" class="text-inherit">Cleaning Essentials</a></h2>
                         <div>
                            <span class="text-dark fs-5 fw-bold">$120</span>
                            <span class="text-decoration-line-through text-muted">$165</span>
                         </div>
                   ...
                   <div class="row row-cols-xl-4 row-cols-lg-3 g-4">
                      <div class="col">
                         <div class="mb-6">
                            <div class="card card-product mb-4">
                               <div class="card-body text-center py-8">
                                  <!-- img -->
                                  <a href="#"><img src="../assets/images/category/category-instant-food.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                  <!-- text -->
                               </div>
                            </div>
                            <div>
                               <span class="badge bg-danger rounded-pill">-45%</span>
                               <h2 class="mt-3 fs-6"><a href="#" class="text-inherit">Instant Food</a></h2>
                               <div>
                                  <span class="text-dark fs-5 fw-bold">$18</span>
                                  <span class="text-decoration-line-through text-muted">$24</span>
                               </div>
                      ...
                      <div class="col">
                         <div class="mb-6">
                            ...
                            <div class="card card-product mb-4">
                               <div class="card-body text-center py-8">
                                  <!-- img -->
                                  <a href="#"><img src="../assets/images/category/category-baby-care.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                  <!-- text -->
                               </div>
                            </div>
                            <div>
                               <span class="badge bg-danger rounded-pill">-55%</span>
                               <h2 class="mt-3 fs-6"><a href="#" class="text-inherit">Baby Care</a></h2>
                               <div>
                                  <span class="text-dark fs-5 fw-bold">$18</span>
                                  <span class="text-decoration-line-through text-muted">$24</span>
                               </div>
                      ...
                      <div class="col">
                         <div class="mb-6">
                            ...
                            <div class="card card-product mb-4">
                               <div class="card-body text-center py-8">
                                  <!-- img -->
                                  <a href="#"><img src="../assets/images/category/category-pet-care.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                  <!-- text -->
                               </div>
                            </div>
                            <div>
                               <span class="badge bg-danger rounded-pill">-55%</span>
                               <h2 class="mt-3 fs-6"><a href="#" class="text-inherit">Pet Cares</a></h2>
                               <div>
                                  <span class="text-dark fs-5 fw-bold">$18</span>
                                  <span class="text-decoration-line-through text-muted">$24</span>
                               </div>
                      ...
                      <div class="col">
                         <div class="mb-6">
                            ...
                            <div>
                               <span class="badge bg-danger rounded-pill">-25%</span>
                               <h2 class="mt-3 fs-6"><a href="#" class="text-inherit">Bakery & Biscuits</a></h2>
                               <div>
                                  <span class="text-dark fs-5 fw-bold">$120</span>
                                  <span class="text-decoration-line-through text-muted">$165</span>
                               </div>
